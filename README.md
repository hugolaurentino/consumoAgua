...
A tabela abaixo informa o risco de complicações na saúde com base na ingestão diária de água.

| Quantidade (litros) | Risco    | Mensagem                                                                |
| ------------------- | -------- | ----------------------------------------------------------------------- |
| Menos de 1.5        | ALTO     | Risco Alto - Você está ingerindo pouquíssima água, beba mais água!      |
...
$ git clone https://github.com/hugolaurentino/consumoAgua.git
